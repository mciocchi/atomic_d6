...
For contested actions, defenders may choose a Defensive Feat to raise the effective difficulty of the attack (by increasing the attacker’s Feat Level).

Common Defensive Feats:

- Dodge – Avoid the attack entirely
- Block – Use a shield or object to absorb impact
- Parry – Redirect or deflect the attack
- Cover – Take shelter behind an obstacle
- Counterspell – Interrupt magical effects
- Judo Throw – Redirect melee momentum
