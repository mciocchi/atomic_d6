...
For contested actions, defenders may choose how they wish to defend themselves.

Common Defensive Feats:

- Dodge – Jump out of the way to avoid the attack
- Block – Use a shield or object to absorb impact
- Parry – Redirect or deflect the attack using a weapon
- Cover – Take shelter behind an obstacle
- Counterspell – Interrupt a spell with a spell of your own
- Judo Throw – Redirect an attack's momentum away from you
...
- Fire so perfectly that the concept of "distance" ceases to matter—every shot hits.
...
Different societies can have members from different TLs and cultures simultaneously. For instance: on Earth, individuals from post-industrial societies coexist with those from hunter-gatherer societies.
...
- Can require thousands or millions of man hours
- Each Feat might span hours, years, or millennia, depending on the subjective scope of the Narrative
...
For instance: a modern human might struggle to knap flint, his ancestors having lost the art long ago. Conversely, he might struggle while trying to craft a faster-than-light drive because his grasp of the technology is so simplistic that it is indistinguishable from magic for him.

In both situations, characters receive a Malus to crafting the item.
...
- Development of organized warfare, large-scale trade, and simple mechanical engineering.
...
After that, players will need to work with the GM to determine their starting Concept Bonus, and create characters with Concepts rooted in the setting that they created.
